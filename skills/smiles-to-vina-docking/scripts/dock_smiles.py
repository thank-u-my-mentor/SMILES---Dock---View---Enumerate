...
def main() -> None:
    ...
    parser.add_argument("--history-dir", "--ledger-dir", dest="ledger_dir", metavar="HISTORY_DIR", type=Path, required=True, help="Directory for dock_history.csv and pose/log files")
    ...
    parser.add_argument("--vina", default="vina", help="Vina executable; saved after first run")
    ...
    parser.add_argument("--edit-mode", default="default", help="default/add/delete/shrink/drastic or comma-separated modes")
